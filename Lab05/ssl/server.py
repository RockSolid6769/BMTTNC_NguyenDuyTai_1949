...
while True:
    ...
    # Đường dẫn đến file chứng chỉ và khóa (đã tạo ở bước trước)
    ...
    client_thread = threading.create_thread = threading.Thread(target=handle_client, args=(ssl_socket,))
    client_thread.start()